@JS()
library node_modules._types.d3_force;
...
abstract class SimulationNodeDatum {
  ...
  external num /*num|Null*/ get fx;
  external set fx(num /*num|Null*/ v);

  /// Node’s fixed y-position (if position was fixed)
  external num /*num|Null*/ get fy;
  external set fy(num /*num|Null*/ v);
...
abstract class Simulation<NodeDatum extends SimulationNodeDatum,
    LinkDatum extends dynamic /*SimulationLinkDatum<NodeDatum>|dynamic*/ > {
  ...
  /*external F|dynamic force<F extends Force<NodeDatum,LinkDatum>>(String name);*/
  ...
  external dynamic /*F|dynamic|Simulation*/ force/*<F extends Force<NodeDatum,LinkDatum>>*/(
      String name,
  ...
  /*external VoidFunc0|dynamic on('tick'|'end'|String typenames);*/
  ...
  external dynamic /*VoidFunc0|dynamic|Simulation*/ on(
...
abstract class ForceLink<NodeDatum extends SimulationNodeDatum,
  ...
  /// For details regarding the default behavior see: [https://github.com/d3/d3-force#link_strength]
